...
class ConceptRelationship(Record):
...
class ConditionOccurrence(Record):
...
class ObservationPeriod(Record):
...
class ProcedureOccurrence(Record):
...
class SourceToConceptMap(Record):
